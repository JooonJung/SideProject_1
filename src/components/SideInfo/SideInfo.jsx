  ...
  return (
    <div className="sideInfo">
      <div className="infoItem1">
        ...
        <div className="infoText">{item.addressFirst}</div>
      </div>
      <div className="infoItem1">
        <div className="infoItemTitle">방구조</div>
        <Separator height={"8px"} />
        <div className="infoText">{item.structure}</div>
      </div>
      <div className="infoItem1">
        <div className="infoItemTitle">거래 정보</div>
        <Separator height={"8px"} />
        <div className="infoText">{item.saleType}</div>
      </div>
      <div className="infoItem1">
        ...
        <div className="feeContainer">
          ...
          <div className="infoAnswer">{item.fee}</div>
        </div>
        <Separator height={"8px"} />
        <div className="feeContainer">
          <div className="infoCategory">금액</div>
          <div className="infoAnswer">{item.price}</div>
        </div>
      </div>
